...
- Development data policy: never add historical-database compatibility fallbacks. During development, prefer clearing/rebuilding the database over introducing legacy parsing or migration workaround logic.
