      ...
      {photo.livePhotoUrl ? (
        ...
        >
          {/* Feedback #117: this used to be Filmstrip24Regular — the exact
              ...
              Feedback #124: the bare icon still wasn't obvious enough on a
              small thumbnail, so it now carries the same "LIVE" text Apple
              Photos puts next to its own live-photo glyph — the icon alone
              reads as an abstract circle, the word doesn't. */}
          <Live24Regular fontSize={14} />
          <span className={css.livePhotoBadgeLabel}>LIVE</span>        </span>
      ) : null}
